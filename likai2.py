...
text=extract_text(r"C:\Users\kai-y\Downloads\教务【2020】71号2020-2021学年第一学期开学初教学工作检查情况通报（一）.pdf")
print(repr(text))
...
# with open(r"D:\projects\div_pdf\score_103667 (1).pdf", 'rb') as in_file:
#     extract_text_to_fp(in_file,output_string,laparams=LAParams(),
#                        output_type='html',codec=None)
# in_file.close()
# # print(output_string.getvalue())
# with open('ttt.html','a',encoding='utf8') as f:
